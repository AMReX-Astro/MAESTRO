...
!..input arguments
      ...
      double precision temp_row(npts), den_row(npts), abar_row(npts), &
                       zbar_row(npts), etot_row(npts), ptot_row(npts), &
                       cv_row(npts), cp_row(npts),  &
                       xne_row(npts), xnp_row(npts), etaele_row(npts), &
                       pele_row(npts), ppos_row(npts), dpd_row(npts),  &
                       dpt_row(npts), dpa_row(npts), dpz_row(npts),  &
                       ded_row(npts), det_row(npts), dea_row(npts),  &
                       dez_row(npts),  &
...
!..store this row
!..MLW: comment out storage to *_row arrays we dont use 
        ptot_row(j)   = pres
        dpt_row(j)    = dpresdt
        dpd_row(j)    = dpresdd
        dpa_row(j)    = dpresda   
