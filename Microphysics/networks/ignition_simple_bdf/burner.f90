module burner_module
   ...
   interface burner
      module procedure burner_orig
      module procedure burner_cyc
   end interface
...
contains
   ...
   subroutine burner_orig(dens, temp, Xin, dt, Xout, rho_omegadot, rho_Hnuc)
   !$acc routine seq
      ...
      integer(8)      :: clock_start, clock_stop
      ...
      !nlu = nlu + iwork(19)
      !nit = nit + iwork(20)
   end subroutine burner_orig

   subroutine burner_cyc(dens, temp, Xin, dt, Xout, rho_omegadot, rho_Hnuc, cycs)
   !$acc routine seq
      ...
      real(kind=dp_t) :: upar(n_rpar_comps, burn_npts), y0(neqs, burn_npts), y1(neqs, burn_npts)
      real(kind=dp_t) :: t0, t1, enuc, dX
      integer(8)      :: clockt_start, clockt_stop
      integer(8)      :: clockb_start, clockb_stop
      integer(8)      :: clocka_start, clocka_stop
      type(eos_t)  :: eos_state
      type(bdf_ts) :: ts
