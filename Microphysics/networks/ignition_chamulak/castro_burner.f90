...
!$omp threadprivate(/zone_pass/)
    ...
    ! compute the energy release and update the enthalpy.
    ! Our convention is that the binding energies are negative, so the energy release is
