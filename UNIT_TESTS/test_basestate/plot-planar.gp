...
plot 'base.orig'                     using 1:2 ti "t=0" with lines ls 1,\
     ...
     'compressible-1.e16-t=5.00.out' using 1:2 ti "compressible" with lines ls 3;
...
plot 'base.orig'                     using 1:3 ti "t=0" with lines ls 1,\
     ...
     'compressible-1.e16-t=5.00.out' using 1:3 ti "compressible" with lines ls 3;
...
plot 'base.orig'                     using 1:4 ti "t=0" with lines ls 1,\
     ...
     'compressible-1.e16-t=5.00.out' using 1:4 ti "compressible" with lines ls 3;
