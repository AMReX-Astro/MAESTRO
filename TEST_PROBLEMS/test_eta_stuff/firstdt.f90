...
contains
  ...
  subroutine firstdt(n,u,s,force,divU,p0,gam1,dx,cflfac,dt)

    integer        , intent(in   ) :: n
    type(multifab) , intent(in   ) :: u,s,force,divU
    real(kind=dp_t), intent(in   ) :: p0(0:), cflfac, gam1(0:)
  ...
  subroutine firstdt_3d(n,u,s,force,divU,p0,gam1,lo,hi,ng,dx,dt,cfl)
