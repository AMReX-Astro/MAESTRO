...
module pert_form_module
  ...
  public :: put_in_pert_form, put_in_pert_form_inflow
...
!$omp end parallel do
  ...
  subroutine put_in_pert_form_inflow(mla,s,base,dx,comp,bc_comp,flag,the_bc_level)
    ...
    do n=1,nlevs
       call multifab_build(base_3d(n), mla%la(n), 1, ng)
    end do

    call put_1d_array_on_cart(base,base_3d,foextrap_comp,.false., &
  ...
  end subroutine put_in_pert_form_inflow
