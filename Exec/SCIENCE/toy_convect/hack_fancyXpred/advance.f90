...
contains
  ...
  subroutine advance_timestep(init_mode,mla,uold,sold,unew,snew, &
    ...
    type(multifab) ::              sedge0(mla%nlevel,mla%dim)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    call density_advance(mla,1,s1,s2,sedge,sedge0,sflux,scal_force,umac,w0,w0mac,etarhoflux, &
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    call density_advance(mla,2,s1,s2,sedge,sedge0,sflux,scal_force,umac,w0,w0mac,etarhoflux, &
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    call hgproject(proj_type,mla,unew,uold,rhohalf,pi,gpi,dx,dt,the_bc_tower,div_coeff_cart,nodalrhs)
