#!/bin/ksh
#PBS -A ast106sbu
#PBS -N rhoc-5.5_Tc-3.0_sT_bF
#PBS -j oe
#PBS -q batch
#PBS -l walltime=06:00:00,nodes=256

# this script runs with 8 threads per MPI task, 2 MPI tasks/node, and 256 nodes on titan 
#
...
aprun -n 512 -S 1 -d 8 -ss ./main.Linux.Cray.mpi.omp.exe inputs_3d_4level_Tc3e8_rhoc5.5e9 ${restartString}
