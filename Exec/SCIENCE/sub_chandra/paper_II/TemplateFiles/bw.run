...
# -j  is the number of cores to use per compute unit (per Bulldozer module).
...
aprun -n 512 -S 1 -d $OMP_NUM_THREADS -j 2 -ss ./main.Linux.Cray.mpi.omp.exe inputs_3d.256.5dr.eq.dx_2levs ${restartString}
