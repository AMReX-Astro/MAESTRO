#!/bin/ksh
#PBS -A ast106
#PBS -N 11030-107-190-4lev-d25
#PBS -j oe
#PBS -q batch
#PBS -l walltime=04:00:00,nodes=128

# this script runs with 16 threads,1 MPI tasks/node, and 128 nodes on titan
#
...
aprun -n 128 -N 1 -d $OMP_NUM_THREADS -ss ./main.Linux.Cray.mpi.omp.exe inputs3d.11030-107-190-4lev-d25 ${restartString}
