...
! We modify this for the incompressible shear jet problem because we start 
! with a domain that has no velocity divergence.  This results in the default HG
! projection tolerance being too small.
...
module mg_eps_module
  ...
  real (kind=dp_t) :: eps_hg = 1.d-11       !Changed from default of d-12
