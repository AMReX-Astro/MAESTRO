...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  subroutine make_gamma(nlevs,gamma,s,p0)
    ...
    do n = 1, nlevs
       do i = 1, s(n)%nboxes
          ...
          select case (dm)
          case (2)
             call make_gamma_2d(lo,hi,gamp(:,:,1,1),sp(:,:,1,:),p0(n,:))
          case (3)
             call make_gamma_3d(lo,hi,gamp(:,:,:,1),sp(:,:,:,:),p0(n,:))
          end select
       end do
    end do
   ...
   subroutine make_gamma_2d(lo,hi,gamma,s,p0)
...
!                     do_diag)
    ...
    subroutine make_gamma_3d(lo,hi,gamma,s,p0)
