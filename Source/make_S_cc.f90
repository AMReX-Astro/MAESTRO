...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    do n = 1, nlevs
       ...
       do i = 1, nfabs(state(n))
          ...
          if (spherical == 1 .or. polar == 1) then
             ...
             select case(dm)
             case(2)
                call make_S_cc_2d_polar(lo, hi, srcp(:,:,1,1), ng_sr, dgtp(:,:,1,1), ng_dt, &
                                 dgp(:,:,1,1), ng_dg, &
                                 sp(:,:,1,:), ng_s, up(:,:,1,:), ng_u, &
  ...
  subroutine make_S_cc_2d_polar(lo,hi,S_cc,ng_sr,dg1_term,ng_dt,delta_gamma1, &
    ...
    real (kind=dp_t), intent(  out) ::           S_cc(lo(1)-ng_sr:,lo(2)-ng_sr:)
  ...
  end subroutine make_S_cc_2d_polar
