...
contains
  ...
  subroutine burner(dens, temp, Xin, dt, Xout, rho_omegadot, rho_Hnuc)
    ...
    !print *, 'Integration in: '
    !print *, '  NEQ:          ', NEQ
    !print *, '  y:            ', y
    !print *, '  rho:          ', rpar(irp_dens)
    !print *, '  c_p:          ', rpar(irp_cp)
    !print *, '  dhdX:         ', rpar(irp_dhdX:irp_dhdX-1+nspec)
    !print *, '  X_O16:        ', rpar(irp_o16)
    !print *, '  dt:           ', dt
    r1 = parallel_wtime()
    ...
    !print *, 'Integration time: ', r2
    !print *, '  yout:           ', y
    !print *, '  update:         ', update_total
    !print *, '  predict:        ', predict_total
    !print *, '  solve:          ', solve_total
    !print *, '  check:          ', check_total
    !print *, '  correct:        ', correct_total
    !print *, '  adjust:         ', adjust_total
  ...
  subroutine burner_vec(dens, temp, Xin, dt, Xout, rho_omegadot, rho_Hnuc)
    ...
    integer, parameter :: LIW = 30 + NEQ
    integer, parameter :: MAX_ORDER = 6   !TODO: This choice is arbitrary, should find optimal value
    integer, parameter :: VEC_LENGTH = 64 !The optimum choice is device-dependent.
    real(kind=dp_t), parameter :: DT0 = 1.0d-13
    ...
    ts%dt_min = epsilon(ts%dt_min)*1.0d-3
    ...
    r1 = parallel_wtime()
    call bdf_advance(ts, f_rhs_vec, jac_vec, NEQ, npts, y, time, yout, dt, &
    ...
    if (ierr /= BDF_ERR_SUCCESS) then
       print *, 'ERROR: integration failed in net'
       print *, 'ierr = ', ierr
       print *, 'msg  = ', errors(ierr)
       call bl_error("ERROR in burner: integration failed")
    endif

    print *, 'F evals:    ', ts%nfe
    print *, 'J evals:    ', ts%nje
    print *, 'LU decomps: ', ts%nlu
    print *, 'Solver its: ', ts%nit
