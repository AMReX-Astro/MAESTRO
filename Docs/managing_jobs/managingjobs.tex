...
\section{Using Blue Waters}

\subsection{Overview}

Each node has 2 compute units, and a compute unit has 16 integer / 8
floating point cores.  They suggest you run using all the integer
cores.  Furthermore, each compute unit is separated into 2 NUMA nodes.
...
The {\tt usage} command will list your usage and {\tt usage -P {\em account}} will
list the usage for all users on an account.
