...
The \boxlib\ floating point exception trapping is disabled with PGI compilers, due to 
...
Jobs are submitted with {\tt sbatch}.  A job can be canceled using {\tt scancel}, and
the status can be checked using {\tt squeue -u {\em username}}.
