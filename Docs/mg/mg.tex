...
\section{\fboxlib\ Multigrid Philosophy}
...
There are several bottom solvers available in \fboxlib.  For \maestro.
...
\fboxlib---one for cell-centered data and one for node-centered (nodal)
