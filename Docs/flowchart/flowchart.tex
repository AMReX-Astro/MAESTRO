...
found by averaging (\ref{eq:flow:continuity}) and (\ref{eq:flow:enthalpy})
respectively over a layer of constant radius, resulting in
\begin{eqnarray}
\frac{\partial\rho_0}{\partial t} &=& -\nabla\cdot(\rho_0 w_0 \eb_r),\label{eq:Base State Density}\\
