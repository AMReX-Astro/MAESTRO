...
{\tt AmrPostprocessing/F\_Src/python\_plotfile} provide some simple commandline
...
\begin{verbatim}
export PYTHONPATH="${PYTHONPATH}:/home/user/AmrPostprocessing/F_Src/python_plotfile}
\end{verbatim}
to your {\tt .bashrc}.
