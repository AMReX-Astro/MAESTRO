...
\amrvis\ is a tool developed together with \amrex\ to visualize
datasets from codes built around the \amrex\ library (including
\fboxlib\ used here).  You can download the \amrvis\ source from:
