...
\begin{itemize}
\item {\tt mini\_plot\_int} is the interval in steps between successive plotfiles
\item {\tt mini\_plot\_deltat} is the interval in time between successive plotfiles
\item {\tt mini\_plot\_base\_name} is the base name that prefixes the plotfiles.  The
  default is {\tt miniplt}
\end{itemize}

To set the fields that are stored in the mini plotfile, a second set
of runtime parameters is used: {\tt mini\_plot\_var1}, {\tt
