...
\rowcolor{tableShade}
\verb= burning_cutoff_density = &  Burning cutoff density (do not burn if density is below this threshold) Initialized to zero, runtime_init() in probin.f90 will check to see if burning_cutoff_density < 0 and if so will set burning_cutoff_density = base_cutoff_density & -1.0d0 \\
