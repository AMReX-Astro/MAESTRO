...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    if (dpdt_factor .gt. ZERO ) then
       ...
       ! pass through dx for time independent composition profile
       call makePfromRhoH(sold,sold,peos_old,mla,the_bc_tower%bc_tower_array, dx)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    if (use_tfromp) then
       ...
       ! pass through dx for time independent composition
       call makeTfromRhoH(s2,mla,the_bc_tower%bc_tower_array, dx)
    end if
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    if (dpdt_factor .gt. ZERO) then
       ...
       ! pass through dx for time independent composition
       call makePfromRhoH(snew,snew,peos_new,mla,the_bc_tower%bc_tower_array, dx)
