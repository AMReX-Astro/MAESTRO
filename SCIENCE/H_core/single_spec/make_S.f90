...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  subroutine make_S_1d(n,lo,hi,Source,ng_sr,delta_gamma1_term,ng_dt,delta_gamma1,ng_dg, &
    ...
    use probin_module, only: use_delta_gamma1_term, prob_lo
    ...
    !     Local variables
    integer         :: i, comp
    real(kind=dp_t) :: sigma, xi_term, pres_term, gradp0, x
  ...
  subroutine make_S_2d(n,lo,hi,Source,ng_sr,delta_gamma1_term,ng_dt,delta_gamma1,ng_dg, &
    ...
    !     Local variables
    integer         :: i, j, comp
    real(kind=dp_t) :: sigma, xi_term, pres_term, gradp0, y 
  ...
  subroutine make_S_3d(n,lo,hi,Source,ng_sr,delta_gamma1_term,ng_dt,delta_gamma1,ng_dg, &
    ...
    !     Local variables
    integer         :: i, j, k, comp
    real(kind=dp_t) :: sigma, xi_term, pres_term, gradp0, z
       ...
       do j = lo(2), hi(2)
          do i = lo(1), hi(1)
             ...
             if (use_delta_gamma1_term .and. k < anelastic_cutoff_coord(n)) then
                ...
                delta_gamma1_term(i,j,k) = (gam1_eos(1) - gamma1bar(k))*u(i,j,k,3)* &
  ...
  subroutine make_S_3d_sphr(lo,hi,Source,ng_sr,dg1_term,ng_dt,delta_gamma1, &
                            ...
                            rho_Hext,ng_he,thermal,ng_th, dx)
    ...
    use variables, only: rho_comp, temp_comp, spec_comp
    use probin_module, only: use_delta_gamma1_term, prob_lo
    use geometry, only: anelastic_cutoff_coord, nr, center
    ...
    !     Local variables
    integer         :: i, j, k, comp
    real(kind=dp_t) :: sigma, xi_term, pres_term, x,y,z,r
