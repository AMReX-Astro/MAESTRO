...
{\bf Step 2A-ii:} Advance the species and density with the advective fluxes.  Solve a Crank-Nicolson diffusion equation to advance enthalpy, using base-time transport coefficients everywhere.\\
