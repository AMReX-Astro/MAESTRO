...
{\tt data\_processing/python\_plotfile} provide a simple commandline tool for doing 
visualizations of 2-d BoxLib plotfiles.  The main driver
is written in python and uses a set of Fortran routines, compiled with
{\tt f2py} to interface with the plotfile data.  To use the routine,
you will need to have {\tt matplotlib} and {\tt f2py} installed.  On
a machine running Fedora linux, you can install these packages via
\begin{verbatim}
