...
\begin{eqnarray}
\rho^{(1),\nph,\star} &=& 
\left[\rho^{'(1),\nph,\star} + \left(\frac{\rho_0^n + \rho_0^{(2),\star}}{2}\right)\right] 
\enskip , \\
...
\begin{equation}
 \etarho^{\nph,\star} =  {\rm {\bf Avg}} \sum_k \left[ (\uadvone \cdotb \er + w_0^{\nph,\star}) (\rho X_k)^{(1),\nph,\star} \right] - w_0^{\nph,\star} \rho_0^{\nph,\star,{\rm pred}} \enskip ,
\end{equation}
\begin{equation}
...
\begin{eqnarray}
\rho^{(1),\nph} &=& 
\left[\rho^{'(1),\nph} + \left(\frac{\rho_0^n + \rho_0^{(2)}}{2}\right)\right] 
\enskip , \\
(\rho X_k)^{(2)} &=& (\rho X_k)^{(1)} 
...
\begin{equation}
 \etarho^{\nph} = {\rm {\bf Avg}} \sum_k \left [\uadvtwo \cdotb \er + w_0^{\nph}) (\rho X_k)^{(1),\nph} \right] - w_0^{\nph} \rho_0^{\nph,{\rm pred}} \enskip ,
\end{equation}
\begin{equation}
