...
\begin{equation}
\rho^{(1),\nph,\star} = 
\rho^{'(1),\nph,\star} + \left(\frac{\rho_0^n + \rho_0^{(2),\star}}{2}\right) \enskip ,
\end{equation}
...
\begin{equation}
(\rho h)^{(1),\nph,\star} = 
(\rho h)^{'(1),\nph,\star} + \left(\frac{(\rho h)_0^n + (\rho h)_0^{(2),\star}}{2}\right)
\enskip .
\end{equation}
...
\begin{equation}
\rho^{(1),\nph} = \rho^{'(1),\nph} + \left(\frac{\rho_0^n + \rho_0^{(2)}}{2}\right)\enskip ,
\end{equation}
...
\begin{equation}
(\rho h)^{(1),\nph} = 
(\rho h)^{'(1),\nph} + \left(\frac{(\rho h)_0^n + (\rho h)_0^{(2)}}{2}\right) \enskip .
\end{equation}
