...
M.~Zingale, A.~S.~Almgren, J.~B.~Bell, A.~Nonaka, \& S.~E.~Woosley
  2009, ApJ, submitted (henceforth paper~IV)
\end{itemize}
...
\item {\bf Compute} {\boldmath $w_0$} {\bf Spherical}$[\Sbar^{\inp},\gammabar^{\inp},\rho_0^{\inp},p_0^{\inp},g^\inp,\etarho^{\inp}] \rightarrow[w_0^{\outp}]$:
