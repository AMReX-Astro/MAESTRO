...
\item For spherical, (See Section \ref{Sec:eta Spherical} for working notes).
...
\rhozero^{n+\myhalf,*},p_0^{n+\myhalf,*},\etarho^{n+\myhalf,\star}] \rightarrow [w_0^{n+\myhalf}]$.
\end{description}
% VOLUME DISCREPANCY STUFF
%\begin{equation}
