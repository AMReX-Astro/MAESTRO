...
\end{description}
\MarginPar{Rework Advect Base Pressure Spherical to take time-centered $\gammabar$?  Also, look at how $\psi^n$ is computed.  The base time centering doesn't make sense.}
