...
&&  - \left( \frac{4}{r_{j-\myhalf} ^3} \frac{p_{0,i} - p_{0,i-1}}{\dr} \right) (r^2 \dw)_{j-\myhalf}  \nonumber \\
&=&   \left( \frac{4}{r_{j-\myhalf} ^3} \frac{p_{0,i} - p_{0,i-1}}{\dr} \right) (r^2 \ow)_{j-\myhalf}
 - \frac{g_{j-\myhalf}}{r_{j-\myhalf}^2 \Delta r} 
  \left[ \left( r^2 \etarho \right)_{j} - \left( r^2 \etarho  \right)_{j-1} \right] 
- \left(  4 \pi G \rhozero \etarho   \right)_{j-\myhalf} \enskip. \nonumber \\
\end{eqnarray}
...
then:
\begin{eqnarray}
A_j &=& \frac{1}{\Delta r^2} \left( \frac{\gammabar p_0}{r^2}\right)_{j-1}  \enskip, \nonumber  \\
B_j &=& -\frac{1}{\Delta r^2} \left[ \left( \frac{\gammabar p_0}{r^2}\right)_{j  }  
               +\left( \frac{\gammabar p_0}{r^2}\right)_{j-1} \right] 
              - \left( \frac{4}{r_{j-\myhalf} ^3} \frac{p_{0,i} - p_{0,i-1}}{\dr} \right) \nonumber \\
C_j &=& \frac{1}{\Delta r^2} \left( \frac{\gammabar p_0}{r^2}\right)_{j}  \enskip, \nonumber  \\
F_j &=&  \left( \frac{4}{r_{j-\myhalf} ^3} \frac{p_{0,i} - p_{0,i-1}}{\dr} \right) (r^2 \ow)_{j-\myhalf}
 - \frac{g_{j-\myhalf}}{r_{j-\myhalf}^2 \Delta r} 
\left[ \left( r^2 \etarho \right)_{j} - \left( r^2 \etarho  \right)_{j-1} \right] 
- \left(  4 \pi G \rhozero \etarho   \right)_{j-\myhalf} \enskip \nonumber .
\end{eqnarray}
Here,
\begin{equation}
g_{j-\myhalf} = \frac{G}{r_{j-\myhalf}^2} \sum_{k=1}^{j} \frac{4}{3} \pi  (r_{k-\myhalf}^3 - r_{k-\thalf}^3) \; {\rho_0}_{k-1} \enskip.
\end{equation}
...
\item {\bf Compute $w_0$ Planar}$[\overline{S^{\nph,\star}},\gammabar^n,p_0^n,\psi^{n-\myhalf}]
