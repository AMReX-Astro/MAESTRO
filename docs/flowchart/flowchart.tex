...
\begin{description}
\item[plane-parallel:]{\bf Compute $w_0$ Planar}$[\overline{S^{\nph,\star}},
\gammabar^n,p_0^n,\psi^{n-\myhalf}]\rightarrow [w_0^{n+\myhalf,*}]$.
\item[spherical:]{\bf Compute $w_0$ Spherical}$[\overline{S^{\nph,\star}},\gammabar^n,
\rhozero^n,p_0^n,\etarho^{n-\myhalf}] \rightarrow [w_0^{n+\myhalf,*}]$.
\end{description}
