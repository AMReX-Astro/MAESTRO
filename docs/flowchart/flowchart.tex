...
\item (spherical only) {\bf Advect Base Pressure}
...
\item (plane-parallel only only) {\bf Advect Base Pressure}
...
\item (plane-parallel only) {\bf Advect Base Pressure}
