...
\begin{equation}
m_{j-\myhalf} = \sum_{k=1}^j \frac{4}{3}\pi\left(r_{k-\myhalf}^3 - r_{k-\sfrac{3}{2}}^3\right)\rho_{0,k-1}^{\inp}; ~~~~~ m_j = m_{j-\myhalf} + \frac{4}{3}\pi \left(r_k^3 - r_{k-\myhalf}^3\right)\rho_{0,k}^{\inp} \enskip .
\end{equation}
