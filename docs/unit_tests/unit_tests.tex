...
\begin{figure}[t] 
\centering
\includegraphics[height=1.8in]{\unitfigpath/wall_u_init_x-velocity} 
\includegraphics[height=1.8in]{\unitfigpath/wall_u_plus_grad_phi_x-velocity} 
\includegraphics[height=1.8in]{\unitfigpath/wall_u_new_x-velocity} 
%
