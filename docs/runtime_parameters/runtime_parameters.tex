...
\verb=  use_linear_grav_in_beta  = &   when integrating $\beta_0$, use a piecewise linear (.true.) representation of gravity or piecewise constant (.false.)  &  .false. \\
...
\verb=  change_max_grid_size_1  = &  On restart, change the max grid size on the base level to max\_grid\_size\_1.  &  .false. \\
