...
\verb=  cluster_min_width  = &   The minimum size on a side for a grid created using make\_new\_grids.  &  16 \\
...
\verb=  drdxfac  = &   ratio of radial base state cells to Cartesian full state cells for spherical geometry, (i.e. $\Delta r = \Delta x/ \mathtt{drdxfac}$)  &  1 \\
...
\verb=  use_etarho  = &   turn on the $\etarho$ term as described in the flow chart  &  .true. \\
