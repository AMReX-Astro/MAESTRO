...
u_{\ib-\half\eb_x}^{1D} =
\begin{cases}
0, & (u_{L,\ib-\half\eb_x}^{1D} \le 0 ~ {\rm AND} ~ u_{R,\ib-\half\eb_x}^{1D} \ge 0 ~ {\rm OR} ~ |u_{L,\ib-\half\eb_x}^{1D} + u_{R,\ib-\half\eb_x}^{1D}| < \epsilon, \\
...
v_{\ib-\half\eb_x}^{1D} =
\begin{cases}
\half(v_{L,\ib-\half\eb_x}^{1D} + v_{R,\ib-\half\eb_x}^{1D}), & \left|u_{\ib-\half\eb_x}^{1D}\right| < \epsilon \\
...
u_{\ib-\half\eb_x}^{\mac} =
\begin{cases}
0, & (u_L^{\mac} \le 0 ~ {\rm AND} ~ u_R^{\mac} \ge 0 ~ {\rm OR} ~ |u_L^{\mac} + u_R^{\mac}| < \epsilon, \\
