...
\item Concerning (\ref{Force Term}), do we really need to include the term proportional to $\partial\pi_0/\partial r$ in the edge-state prediction?  If so, do we use the $\pi_0$ or $w_0$ formulation (refer to Paper III equation [38])?
