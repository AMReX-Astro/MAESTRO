...
\begin{eqnarray}
\Ub_{L,\ib-\half\eb_x}^{1D} &=& \Ub_{\ib-\eb_x} + \left(\half - \frac{\dt}{2h}{\rm max}(0,u_{\ib-\eb_x})\right)\Delta_x\Ub_{\ib-\eb_x}, \label{varden U_L^1D} \\
\Ub_{R,\ib-\half\eb_x}^{1D} &=& \Ub_{\ib} + \left(\half - \frac{\dt}{2h}{\rm min}(0,u_{\ib})\right)\Delta_x\Ub_{\ib}.
\end{eqnarray}
...
&& - \frac{\dt}{4h}\left(w_{\ib+\half\eb_z}^{1D}+w_{\ib-\half\eb_z}^{1D}\right)\left(u_{\ib+\half\eb_z}^{z|y}-u_{\ib-\half\eb_z}^{z|y}\right).
\end{eqnarray}
...
\begin{eqnarray}
s_{L,\ib-\half\eb_x}^{\edge} &=& s_{L,\ib-\half\eb_x}^{1D} + \frac{\dt}{2}f_{s,\ib-\eb_x} - (s\nabla\cdot\Ub^{\mac})_{\ib-\eb_x} \nonumber \\
&&- \frac{\dt}{2h}\left[(s^{1D} v^{\mac})_{\ib-\eb_x+\half\eb_y} - (s^{1D} v^{\mac})_{\ib-\eb_x-\half\eb_y}\right] + \frac{\dt}{2h}s_{\ib-\eb_x}\left(v_{\ib-\eb_x+\half\eb_y}^{\mac} - v_{\ib-\eb_x-\half\eb_y}^{\mac}\right), \nonumber \\
&& \\
s_{R,\ib-\half\eb_x}^{\edge} &=& s_{R,\ib-\half\eb_x}^{1D} + \frac{\dt}{2}f_{s,\ib} - (s\nabla\cdot\Ub^{\mac})_{\ib} \nonumber \\
&&- \frac{\dt}{2h}\left[(s^{1D} v^{\mac})_{\ib+\half\eb_y} - (s^{1D} v^{\mac})_{\ib-\half\eb_y}\right] + \frac{\dt}{2h}s_{\ib}\left(v_{\ib+\half\eb_y}^{\mac} - v_{\ib-\half\eb_y}^{\mac}\right).
\end{eqnarray}
The extrapolation of a ``non-conserved'' $s$ to x-faces is:
\begin{eqnarray}
s_{L,\ib-\half\eb_x}^{\edge} &=& s_{L,\ib-\half\eb_x}^{1D} + \frac{\dt}{2}f_{s,\ib-\eb_x} - \frac{\dt}{4h}\left(v_{\ib-\eb_x+\half\eb_y}^{\mac}+v_{\ib-\eb_x-\half\eb_y}^{\mac}\right)\left(s_{\ib-\eb_x+\half\eb_y}^{1D} - s_{\ib-\eb_x-\half\eb_y}^{1D}\right), \nonumber \\
&& \\
s_{R,\ib-\half\eb_x}^{\edge} &=& s_{R,\ib-\half\eb_x}^{1D} + \frac{\dt}{2}f_{s,\ib} - \frac{\dt}{4h}\left(v_{\ib+\half\eb_y}^{\mac}+v_{\ib-\half\eb_y}^{\mac}\right)\left(s_{\ib+\half\eb_y}^{1D} - s_{\ib-\half\eb_y}^{1D}\right).
\end{eqnarray}
Then, we upwind based on $u^{\mac}$.
\begin{equation}
s_{\ib-\half\eb_x}^{\edge} =
