...
\begin{eqnarray}
\ut_L &=& \ut_{\ib-\eb_x}^n + \left(\half - \frac{\dt}{h}u_{\ib-\eb_x}^n\right)\Delta_x\ut_{\ib-\eb_x}^n + \frac{\dt}{2}(\Ubt\cdot\eb_r)_{\ib-\eb_x}^n\left(\frac{\partial w_0}{\partial r}\right)_{\ib-\eb_x}(\eb_r\cdot\eb_x)_{\ib-\eb_x}, \\
\ut_R &=& \ut_{\ib}^n + \left(\half - \frac{\dt}{h}u_{\ib}^n\right)\Delta_x\ut_{\ib}^n + \frac{\dt}{2}(\Ubt\cdot\eb_r)_{\ib}^n\left(\frac{\partial w_0}{\partial r}\right)_{\ib}(\eb_r\cdot\eb_x)_{\ib}.
\end{eqnarray}
