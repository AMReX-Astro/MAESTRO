...
$s$ to the hi and lo side of the face, respectively.  See Sections \ref{Sec:ColellaWoodward} 
and \ref{Sec:ColellaSekora} for the two options.
\item {\bf Step 2:} Construct quadratic profiles.
\begin{equation}
...
\end{equation}
\item {\bf Step 3:} Integrate quadratic profiles.\\ \\
...
s_{L,\ib-\myhalf\eb_x} &=&
\begin{cases}
s_{\ib-\eb_x} + \mathcal{I}_{\ib-\eb_x,+}(\sigma), & u_{\ib-\eb_x} ~ \text{or} ~ u_{\ib-\myhalf\eb_x}^{\mac} > 0 \\
s_{\ib-\eb_x}, & \text{else}.
\end{cases}\\
s_{R,\ib-\myhalf\eb_x} &=& 
\begin{cases}
s_{\ib} + \mathcal{I}_{\ib,-}(\sigma), & u_{\ib} ~ \text{or} ~ u_{\ib-\myhalf\eb_x}^{\mac} < 0 \\
s_{\ib}, & \text{else}.
\end{cases}
\end{eqnarray}
\end{itemize}
...
If $s\delta s - \alpha_{i,-} \ge 1\times 10^{-10}$, then
\begin{equation}
