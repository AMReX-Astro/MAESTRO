...
of $s_{L/R,\ib-\half\eb_x}$).  Once these 1D edge states are obtained, we
...
Details...
\item {\bf Step 2:} Modify these states using a quadratic limiter.\\ \\
Details...
\item {\bf Step 3:} Use flattening.\\ \\
Details...
\item {\bf Step 4:} Construct quadratic profiles.\\ \\
Details...
\item {\bf Step 5:} Integrate quadratic profiles.\\ \\
Details...
\item {\bf Step 6:} Perform 1D extrapolation to get left and right edge states.\\ \\
Details...
\end{enumerate}
