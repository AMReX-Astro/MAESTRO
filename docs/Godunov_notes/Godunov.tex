...
\begin{enumerate}
\item Predict $\ut$ to y-faces and r-faces using a 1D extrapolation.
\item Predict $\vt$ to x-faces and r-faces using a 1D extrapolation.
\item Predict $\wt$ to x-faces and y-faces using a 1D extrapolation.
