\section{Godunov advection}

These are working notes for the Godunov step in {\tt MAESTRO} and {\tt
  VARDEN}.

%-----------------------------------------------------------------------------
% note differences
%-----------------------------------------------------------------------------
\subsection{Differences Between These Notes and the Code}
\begin{enumerate}
...
%-----------------------------------------------------------------------------
\subsection{Differences Between {\tt MAESTRO} and {\tt VARDEN}}
\begin{enumerate}
...
% utrans
%-----------------------------------------------------------------------------
\subsection{Computing $\Ubt^{\trans}$ in {\tt MAESTRO}}
...
\subsubsection{2D Cartesian Case}
...
\subsubsection{3D Cartesian Case}
...
\subsubsection{3D Spherical Case}
...
% Umac
%-----------------------------------------------------------------------------
\subsection{Computing $\Ubt^{\mac,*}$ in {\tt MAESTRO}}
...
% edge states
%-----------------------------------------------------------------------------
\subsection{Computing $\rho^{'\edge}, X_k^{\edge}$, and $(\rho h)^{'\edge}/h^{\edge}/T^{\edge}$ in {\tt MAESTRO}}
...
% U-edge states
%-----------------------------------------------------------------------------
\subsection{Computing $\Ubt^{\edge}$ in {\tt MAESTRO}}
...
% Umac in Varden
%-----------------------------------------------------------------------------
\subsection{Computing $\Ub^{\mac,*}$ in {\tt VARDEN}}
...
% Varden edge states
%-----------------------------------------------------------------------------
\subsection{Computing $\Ub^{\edge}$ and $\rho^{\edge}$ in {\tt VARDEN}}
