...
it is not actually part of $f_{\Ub}$.
...
&& - \frac{\dt}{4h}\left(\wt_{\ib-\half\eb_r}^{\trans}+\wt_{\ib-\frac{3}{2}\eb_r}^{\trans}\right)\left(w_{0,\ib-\half\eb_r} - w_{0,\ib-\frac{3}{2}\eb_r}\right) + \frac{\dt}{2}f_{w,\ib-\eb_r}, \\
...
&& - \frac{\dt}{4h}\left(\wt_{\ib+\half\eb_r}^{\trans}+\wt_{\ib-\half\eb_r}^{\trans}\right)\left(w_{0,\ib+\half\eb_r} - w_{0,\ib-\half\eb_r}\right) + \frac{\dt}{2}f_{w,\ib}.
\end{eqnarray}
Solve a Riemann problem:
\begin{equation}
...
Make sure you upwind based on the full velocity, not the
...
like a source term, but it is not actually part of $f_{\Ub}$.
