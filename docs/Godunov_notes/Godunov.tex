...
\begin{eqnarray}
s_L^x &=& s_{\ib-\eb_x} + \left(\half - \frac{\dt}{h_x}\mathrm{UEDGE}_{\ib-\half\eb_x}\right)\Delta^x s_{\ib-\eb_x} + \underbrace{\frac{\dt}{2}\mathrm{TFORCES}_{\ib-\eb_x}}_{\text{IF USE\_MINION}} \\
s_R^x &=& s_{\ib} - \left(\half + \frac{\dt}{h_x}\mathrm{UEDGE}_{\ib-\half\eb_x}\right)\Delta^x s_{\ib} + \underbrace{\frac{\dt}{2}\mathrm{TFORCES}_{\ib}}_{\text{IF USE\_MINION}}
\end{eqnarray}
...
\end{equation}
Then, if $|\mathrm{UEDGE}_{\ib-\half\eb_x}| \le \epsilon$, we set $s_{\ib-\half\eb_x}^x = (s_L^x+s_R^x)/2$.  The procedure to obtain $s_{\ib-\half\eb_y}^y$ is analogous.\\ \\
Now, the transverse terms.\\ \\
{\bf If} ICONSERVE {\bf then:}
\begin{eqnarray}
\mathrm{sedge}_L^x &=& s_{\ib-\eb_x} + \left(\half - \frac{\dt}{h_x}\mathrm{UEDGE}_{\ib-\half\eb_x}\right)\Delta^x s_{\ib-\eb_x} + \frac{\dt}{2}\mathrm{TFORCES}_{\ib-\eb_x} \nonumber\\
&& - \frac{\dt}{2}\left[\frac{\mathrm{VEDGE}_{\ib-\eb_x+\half\eb_y}s_{\ib-\eb_x+\half\eb_y}^y - \mathrm{VEDGE}_{\ib-\eb_x-\half\eb_y}s_{\ib-\eb_x-\half\eb_y}^y}{h_y}\right.\nonumber\\
&& ~~~~~~~~~~ \left. - \frac{s_{\ib-\eb_x}(\mathrm{VEDGE}_{\ib-\eb_x+\half\eb_y}-\mathrm{VEDGE}_{\ib-\eb_x-\half\eb_y})}{h_y}+s_{\ib-\eb_x}\mathrm{DIVU}_{\ib-\eb_x}\right]\\
\mathrm{sedge}_R^x &=& s_{\ib} - \left(\half + \frac{\dt}{h_x}\mathrm{UEDGE}_{\ib-\half\eb_x}\right)\Delta^x s_{\ib} + \frac{\dt}{2}\mathrm{TFORCES}_{\ib} \nonumber\\
&& - \frac{\dt}{2}\left[\frac{\mathrm{VEDGE}_{\ib+\half\eb_y}s_{\ib+\half\eb_y}^y - \mathrm{VEDGE}_{\ib-\half\eb_y}s_{\ib-\half\eb_y}^y}{h_y}\right.\nonumber\\
&& ~~~~~~~~~~ \left. - \frac{s_{\ib}(\mathrm{VEDGE}_{\ib+\half\eb_y}-\mathrm{VEDGE}_{\ib-\half\eb_y})}{h_y}+s_{\ib}\mathrm{DIVU}_{\ib}\right]
\end{eqnarray}
Now, define $\mathrm{VBAR}_{\ib} = (\mathrm{VEDGE}_{\ib+\half\eb_y}+\mathrm{VEDGE}_{\ib-\half\eb_y})/2$.\\ \\
{\bf If} NOT ICONSERVE {\bf and} $\mathrm{VEDGE}_{\ib+\half\eb_y}\cdot\mathrm{VEDGE}_{\ib-\half\eb_y} < 0$ {\bf and} $\mathrm{VBAR}_{\ib} < 0$ {\bf then:}
\begin{eqnarray}
\mathrm{sedge}_R^x = s_{\ib} &-& \left(\half + \frac{\dt}{h_x}\mathrm{UEDGE}_{\ib-\half\eb_x}\right)\Delta^x s_{\ib} + \frac{\dt}{2}\mathrm{TFORCES}_{\ib} \nonumber\\
...
{\bf If} NOT ICONSERVE {\bf and} $\mathrm{VEDGE}_{\ib+\half\eb_y}\cdot\mathrm{VEDGE}_{\ib-\half\eb_y} < 0$ {\bf and} $\mathrm{VBAR}_{\ib} \ge 0$ {\bf then:}
\begin{eqnarray}
\mathrm{sedge}_R^x = s_{\ib} &-& \left(\half + \frac{\dt}{h_x}\mathrm{UEDGE}_{\ib-\half\eb_x}\right)\Delta^x s_{\ib} + \frac{\dt}{2}\mathrm{TFORCES}_{\ib} \nonumber\\
&& - \frac{\dt}{2}\left[\frac{\mathrm{VBAR}_{\ib}(s_{\ib}-s_{\ib-\eb_y})}{h_y}\right]
\end{eqnarray}
Be careful with $\mathrm{sedge}_L^x$ because the conditions correspond to the starting point of the extrapolation, which is different from $\mathrm{sedge}_R^x$.\\ \\
{\bf If} NOT ICONSERVE {\bf and} $\mathrm{VEDGE}_{\ib+\half\eb_y}\cdot\mathrm{VEDGE}_{\ib-\half\eb_y} \ge 0$ {\bf then:}
\begin{eqnarray}
\mathrm{sedge}_R^x = s_{\ib} &-& \left(\half + \frac{\dt}{h_x}\mathrm{UEDGE}_{\ib-\half\eb_x}\right)\Delta^x s_{\ib} + \frac{\dt}{2}\mathrm{TFORCES}_{\ib} \nonumber\\
&& - \frac{\dt}{2}\left[\frac{(\mathrm{VEDGE}_{\ib+\half\eb_y}+\mathrm{VEDGE}_{\ib-\half\eb_y})(s_{\ib+\half\eb_y}-s_{\ib-\half\eb_y})}{2h_y}\right]
\end{eqnarray}
Be careful with $\mathrm{sedge}_L^x$ because the conditions correspond to the starting point of the extrapolation, which is different from $\mathrm{sedge}_R^x$.\\ \\
...
\begin{eqnarray}
s_L^x &=& s_L^x + \frac{\dt}{2}\mathrm{TFORCES}_{\ib-\eb_x} \\
s_R^x &=& s_R^x + \frac{\dt}{2}\mathrm{TFORCES}_{\ib}
\end{eqnarray}
Apply boundary conditions on $s_L^x$ and $s_R^x$.  Then,
\begin{equation}
\mathrm{s}_{\ib-\half\eb_x}^x =
...
\end{equation}
\begin{eqnarray}
\mathrm{sedge}_R^x = s_{\ib} &-& \left(\half + \frac{\dt}{h_x}u_{\ib}\right)\Delta^x s_{\ib} + \frac{\dt}{2}\mathrm{TFORCES}_{\ib} \nonumber\\
&& - \frac{\dt}{2}\left[\frac{(\mathrm{VEDGE}_{\ib+\half\eb_y}+\mathrm{VEDGE}_{\ib-\half\eb_y})(s_{\ib+\half\eb_y}-s_{\ib-\half\eb_y})}{2h_y}\right]
\end{eqnarray}
Be careful with $\mathrm{sedge}_L^x$ because the conditions correspond to the starting point of the extrapolation, which is different from $\mathrm{sedge}_R^x$.\\ \\
