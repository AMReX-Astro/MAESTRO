...
\item {\tt flame}
\item {\tt planar\_heat}
\item {\tt spherical\_heat}
\item {\tt test2}
\item {\tt test\_convect}
\item {\tt test\_spherical}
\end{itemize}
...
\item {\tt ibx} is a \boxtype\ that describes the index range of the valid data
  for the \fab.  This differes from {\tt bx} when the box is nodal in one more more 
  directions.
