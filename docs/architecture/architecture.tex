...
\item {\tt extern/EOS/gamma\_law\_general} assumes an ideal gas with a mixed 
     ...
     proton.
     The mean molecular weight, $\mu$, is computed either assuming 
     ...
     \begin{equation}
     \mu = \left ( \sum_k \frac{X_k (Z_k + 1)}{A_k} \right )^{-1}
     \end{equation}
     The default is neutral, and presently one must change a parameter
     in the source code to switch between these limits.
\end{itemize}
