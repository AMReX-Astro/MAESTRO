...
variable when filling boundaries.  {\tt adv\_bc\_level\_array} is
describes the boundary conditions that are in play for the advection
(hyperbolic) equations.  The form of this array is {\tt
  adv\_bc\_level\_array(0:ngrids,dim,2,nvar)} where the new component,
