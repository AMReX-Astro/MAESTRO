...
module thermal_conduct_module
  ...
  public :: thermal_conduct_predictor
...
contains 
  ...
  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  subroutine thermal_conduct_predictor(mla,dx,dt,sold,hcoeff_old,Xkcoeff_old,pcoeff_old, &
                                       hcoeff_new,Xkcoeff_new,pcoeff_new,snew,p0_old,p0_new, &
                                       intra,the_bc_tower)
